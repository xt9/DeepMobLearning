 ...
 */
public class BlockSimulationChamber extends Block {
    ...
    public BlockSimulationChamber() {
        ...
        setRegistryName(new ResourceLocation(DeepConstants.MODID, "simulation_chamber"));
    ...
    public void getDrops(IBlockState state, NonNullList<ItemStack> drops, World world, BlockPos pos, int fortune) {
        ...
        if(tile instanceof TileEntitySimulationChamber) {
            ...
            drops.add(new ItemStack(Registry.simulationChamberItem));
