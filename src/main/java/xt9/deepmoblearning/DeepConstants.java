...
public class DeepConstants {
    ...
    // Loaded mod booleans
    public static final boolean MOD_TE_LOADED = ModList.get().isLoaded("thermalfoundation");
    public static final boolean MOD_TWILIGHT_LOADED = ModList.get().isLoaded("twilightforest");
    public static final boolean MOD_TCON_LOADED = ModList.get().isLoaded("tconstruct");
    public static final boolean MOD_PATCHOULI_LOADED = ModList.get().isLoaded("patchouli");
